...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'sailing_simulator.data';
      var REMOTE_PACKAGE_BASE = 'sailing_simulator.data';
...
Module['FS_createPath']("/", "shader", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_sailing_simulator.data');

      };
      Module['addRunDependency']('datafile_sailing_simulator.data');
    ...
    loadPackage({"files": [{"filename": "/shader/shader.vert", "start": 0, "end": 359}, {"filename": "/shader/shader.frag", "start": 359, "end": 550}], "remote_package_size": 550});
...
var wasmBinaryFile;
  wasmBinaryFile = 'sailing_simulator.wasm';
